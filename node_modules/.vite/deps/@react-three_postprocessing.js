...
var dt = (0, import_react.memo)((0, import_react.forwardRef)(({ children: e, camera: t, scene: o, resolutionScale: r, enabled: a = true, renderPriority: n = 1, autoClear: i = true, depthBuffer: s, enableNormalPass: l, stencilBuffer: p, multisampling: _ = 8, frameBufferType: S = HalfFloatType }, g) => {
...
var ce = (0, import_react.forwardRef)(function({ blendFunction: e, worldFocusDistance: t, worldFocusRange: o, focusDistance: r, focusRange: a, focalLength: n, bokehScale: i, resolutionScale: s, resolutionX: l, resolutionY: p, width: _, height: S, target: g, depthTexture: d, ...m }, v) {
  const { camera: x } = (0, import_react.useContext)(D), f = g != null, u = (0, import_react.useMemo)(() => {
    const c = new DepthOfFieldEffect(x, { blendFunction: e, worldFocusDistance: t, worldFocusRange: o, focusDistance: r, focusRange: a, focalLength: n, bokehScale: i, resolutionScale: s, resolutionX: l, resolutionY: p, width: _, height: S });
...
var fe = class extends Effect {
  constructor({ blendFunction: t, enabled: o, glareSize: r, lensPosition: a, screenRes: n, starPoints: i, flareSize: s, flareSpeed: l, flareShape: p, animated: _, anamorphic: S, colorGain: g, lensDirtTexture: d, haloScale: m, secondaryGhosts: v, aditionalStreaks: x, ghostScale: f, opacity: u, starBurst: c }) {
    super("LensFlareEffect", _t.fragmentShader, { blendFunction: t, uniforms: /* @__PURE__ */ new Map([["enabled", new Uniform(o)], ["glareSize", new Uniform(r)], ["lensPosition", new Uniform(a)], ["time", new Uniform(0)], ["screenRes", new Uniform(n)], ["starPoints", new Uniform(i)], ["flareSize", new Uniform(s)], ["flareSpeed", new Uniform(l)], ["flareShape", new Uniform(p)], ["animated", new Uniform(_)], ["anamorphic", new Uniform(S)], ["colorGain", new Uniform(g)], ["lensDirtTexture", new Uniform(d)], ["haloScale", new Uniform(m)], ["secondaryGhosts", new Uniform(v)], ["aditionalStreaks", new Uniform(x)], ["ghostScale", new Uniform(f)], ["starBurst", new Uniform(c)], ["opacity", new Uniform(u)]]) });
  }
  update(t, o, r) {
...
var gt = ({ smoothTime: e = 0.07, blendFunction: t = 23, enabled: o = true, glareSize: r = 0.2, lensPosition: a = new Vector3(-25, 6, -60), screenRes: n = new Vector2(0, 0), starPoints: i = 6, flareSize: s = 0.01, flareSpeed: l = 0.01, flareShape: p = 0.01, animated: _ = true, anamorphic: S = false, colorGain: g = new Color(20, 20, 20), lensDirtTexture: d = null, haloScale: m = 0.5, secondaryGhosts: v = true, aditionalStreaks: x = true, ghostScale: f = 0, opacity: u = 1, starBurst: c = false }) => {
  ...
  }, [U]), (0, import_jsx_runtime.jsx)(xt, { ref: E, blendFunction: t, enabled: o, glareSize: r, lensPosition: a, screenRes: n, starPoints: i, flareSize: s, flareSpeed: l, flareShape: p, animated: _, anamorphic: S, colorGain: g, lensDirtTexture: d, haloScale: m, secondaryGhosts: v, aditionalStreaks: x, ghostScale: f, opacity: u, starBurst: c });
};
...
var Ut = (0, import_react.forwardRef)(function({ active: e = true, ...t }, o) {
  const r = useThree((p) => p.invalidate), a = Z(t, "delay"), n = Z(t, "duration"), i = Z(t, "strength"), s = Z(t, "chromaticAberrationOffset"), l = (0, import_react.useMemo)(() => new GlitchEffect({ ...t, delay: a, duration: n, strength: i, chromaticAberrationOffset: s }), [a, n, t, i, s]);
...
var Bt = (0, import_react.forwardRef)(function({ selection: e = [], selectionLayer: t = 10, blendFunction: o, patternTexture: r, edgeStrength: a, pulseSpeed: n, visibleEdgeColor: i, hiddenEdgeColor: s, width: l, height: p, kernelSize: _, blur: S, xRay: g, ...d }, m) {
  const v = useThree((U) => U.invalidate), { scene: x, camera: f } = (0, import_react.useContext)(D), u = (0, import_react.useMemo)(() => new OutlineEffect(x, f, { blendFunction: o, patternTexture: r, edgeStrength: a, pulseSpeed: n, visibleEdgeColor: i, hiddenEdgeColor: s, width: l, height: p, kernelSize: _, blur: S, xRay: g, ...d }), [o, S, f, a, p, s, _, r, n, x, i, l, g]), c = (0, import_react.useContext)(H);
  return (0, import_react.useEffect)(() => {
    if (!c && e)
...
var kt = (0, import_react.forwardRef)(function({ selection: e = [], selectionLayer: t = 10, lights: o = [], inverted: r = false, ignoreBackground: a = false, luminanceThreshold: n, luminanceSmoothing: i, intensity: s, width: l, height: p, kernelSize: _, mipmapBlur: S, ...g }, d) {
  ...
  const m = useThree((c) => c.invalidate), { scene: v, camera: x } = (0, import_react.useContext)(D), f = (0, import_react.useMemo)(() => {
    const c = new SelectiveBloomEffect(v, x, { blendFunction: 0, luminanceThreshold: n, luminanceSmoothing: i, intensity: s, width: l, height: p, kernelSize: _, mipmapBlur: S, ...g });
    return c.inverted = r, c.ignoreBackground = a, c;
  }, [v, x, n, i, s, l, p, _, S, r, a, g]), u = (0, import_react.useContext)(H);
  return (0, import_react.useEffect)(() => {
    if (!u && e)
...
var pe = class extends Effect {
  constructor({ rampType: t = 0, rampStart: o = [0.5, 0.5], rampEnd: r = [1, 1], startColor: a = [0, 0, 0, 1], endColor: n = [1, 1, 1, 1], rampBias: i = 0.5, rampGain: s = 0.5, rampMask: l = false, rampInvert: p = false, ..._ } = {}) {
    super("RampEffect", jt.fragmentShader, { ..._, uniforms: /* @__PURE__ */ new Map([["rampType", new Uniform(t)], ["rampStart", new Uniform(o)], ["rampEnd", new Uniform(r)], ["startColor", new Uniform(a)], ["endColor", new Uniform(n)], ["rampBias", new Uniform(i)], ["rampGain", new Uniform(s)], ["rampMask", new Uniform(l)], ["rampInvert", new Uniform(p)]]) });
  }
};
var Ot = P(pe);
...
var ao = (0, import_react.forwardRef)(({ halfRes: e, screenSpaceRadius: t, quality: o, depthAwareUpsampling: r = true, aoRadius: a = 5, aoSamples: n = 16, denoiseSamples: i = 4, denoiseRadius: s = 12, distanceFalloff: l = 1, intensity: p = 1, color: _, renderMode: S = 0 }, g) => {
  const { camera: d, scene: m } = useThree(), v = (0, import_react.useMemo)(() => new $87431ee93b037844$export$2489f9981ab0fa82(m, d), [d, m]);
  return (0, import_react.useLayoutEffect)(() => {
    applyProps(v.configuration, { color: _, aoRadius: a, distanceFalloff: l, intensity: p, aoSamples: n, denoiseSamples: i, denoiseRadius: s, screenSpaceRadius: t, renderMode: S, halfRes: e, depthAwareUpsampling: r });
  }, [t, _, a, l, p, n, i, s, S, e, r, v]), (0, import_react.useLayoutEffect)(() => {
